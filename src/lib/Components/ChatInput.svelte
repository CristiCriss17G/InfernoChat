<script lang="ts">
	import { messages } from '$lib/stores/chatInterface/chatInputStore';
...
<form on:submit={handleSubmit}>
	<div class="input-group input-group-divider chat-input-group">
		...
		<!-- <textarea
			...
			rows="1"
		/> -->
		<button class="variant-filled-secondary" type="submit" disabled={!inputSimple || isLoading}
			>Send</button
		>
	</div>
</form>
